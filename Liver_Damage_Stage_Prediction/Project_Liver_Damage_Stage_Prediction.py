...
print('Accuracy on training data :: ',100 - round(mean_squared_error(y_train,train_pred),4))

# Evaluation on test data
test_pred = model.predict(x_test)
print('Accuracy on test data :: ',100 - round(mean_squared_error(y_test,test_pred),4))
